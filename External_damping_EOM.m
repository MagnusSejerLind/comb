...
syms k_1 k_2 g_1 g_2 
syms c_in_1 c_in_2 d_in_1 d_in_2    % Internal damping
...
ddL_dq_dot_dt = [m*(0.6667*l_1^3*phi_1_dotdot*(a + b) - 0.5000*l_1^2*theta_1_dotdot*(a^2 - b^2) ...
    + 2*l_1^2*l_2*phi_1_dotdot*(a + b) + l_1*l_2^2*phi_2_dotdot*(a + b) - l_1*l_2*theta_2_dotdot*(a^2 - b^2)), ...
m*(0.6667*l_2^3*phi_2_dotdot*(a + b) - 0.5000*l_2^2*theta_2_dotdot*(a^2 - b^2) + l_1*l_2^2*phi_1_dotdot*(a + b)), ...
m*(0.6667*l_1*theta_1_dotdot*(a^3 + b^3) - 0.5000*l_1^2*phi_1_dotdot*(a^2 - b^2)), -m*(0.5000*l_2^2*phi_2_dotdot*(a^2 - b^2) ...
- 0.6667*l_2*theta_2_dotdot*(a^3 + b^3) + l_1*l_2*phi_1_dotdot*(a^2 - b^2))];
%%%%%
